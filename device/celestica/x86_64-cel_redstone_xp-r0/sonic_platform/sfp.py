...
class Sfp(SfpBase):
    ...
    RESET_PATH = "/sys/devices/platform/redstone_xp_cpld/qsfp_reset"
    LP_PATH = "/sys/devices/platform/redstone_xp_cpld/qsfp_lpmode"
    PRS_PATH = "/sys/devices/platform/redstone_xp_cpld/port_presence"
    ...
    def get_reset_status(self):
        ...
        return bin_format[::-1][self._index - 48] == '0'
